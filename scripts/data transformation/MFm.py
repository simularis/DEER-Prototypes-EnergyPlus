...
measure_name = 'HW Boiler Sapce Heating'
#measure_name = 'Steam Boiler Sapce Heating'
...
path = 'Analysis/MFm_HW Boiler_New'
#path = 'Analysis/MFm_HW Boiler_Ex'
#path = 'Analysis/MFm_Steam Boiler_Ex'
#path = 'Analysis/MFm_Steam Boiler_New'
